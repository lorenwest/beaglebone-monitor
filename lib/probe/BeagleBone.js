// BeagleBone.js (c) 2014 Loren West
...
* @param initParams.pins {Array of Object} Initial I/O pin definitions
* @param initParams.pins.n.id {String} The beaglebone ID of the pin ('P9_22')
* @param initParams.pins.n.name {String} The logical name to assign the pin
* @param [initParams.pins.n.type='gpio'] {String} The pin type (gpio, analog, i2c, )
* @param [initParams.pins.n.direction='in'] {String} Pin direction (in or out)

* @param [initParams.pins.n.precision=3] {Number} Number of digits to retain
*                   past the decimal point (rounded) for analog pins.
...
var InputBoard = Probe.extend({
  ...
  initialize: function(attributes, options){
    ...
    t.sleepMs = (typeof attributes.sleepMs === 'undefined') ? 1000 : attributes.sleepMs;
